...
from sites.careerscenter import careerscenterScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = careerscenterScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_careerscenter_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_careerscenter_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_careerscenter_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_careerscenter_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_careerscenter_status_code_link_api(get_job_details):
