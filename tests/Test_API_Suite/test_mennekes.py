...
from sites.mennekes import mennekesScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = mennekesScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
@pytest.mark.skip
def test_mennekes_title_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_mennekes_city_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_mennekes_country_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_mennekes_link_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_mennekes_status_code_link_api(get_job_details):
