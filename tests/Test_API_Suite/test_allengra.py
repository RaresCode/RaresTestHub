...
from sites.allengra import allengraScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = allengraScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_allengra_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_allengra_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_allengra_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_allengra_status_code_link_api(get_job_details):
