...
from sites.canopy import canopyScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = canopyScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_canopy_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_canopy_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_canopy_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_canopy_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_canopy_status_code_link_api(get_job_details):
