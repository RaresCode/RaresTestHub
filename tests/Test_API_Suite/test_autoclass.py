...
from sites.autoclass import autoclassScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = autoclassScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_autoclass_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_autoclass_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_autoclass_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_autoclass_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_autoclass_status_code_link_api(get_job_details):
