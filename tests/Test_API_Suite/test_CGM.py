...
from sites.cgm import CGMScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = CGMScraper().return_data()
...
@pytest.mark.API
def test_CGM_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_CGM_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_CGM_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_CGM_status_code_link_api(get_job_details):
