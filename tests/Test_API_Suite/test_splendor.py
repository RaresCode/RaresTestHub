...
from sites.splendor import splendorScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = splendorScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_splendor_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_splendor_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_splendor_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.APIAPI
def test_splendor_link_api(get_job_details):
