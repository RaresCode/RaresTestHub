...
from sites.urbio import urbioScraper
import pytest
import requests
import allure
...
def get_job_details():
    ...
    """
    scraper_data = urbioScraper().return_data()
...
@pytest.mark.API
def test_urbio_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_urbio_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_urbio_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_urbio_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_urbio_status_code_link_api(get_job_details):
