...
from sites.artvertising import artvertisingScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = artvertisingScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.regression
@pytest.mark.API
def test_artvertising_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_artvertising_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_artvertising_status_code_link_api(get_job_details):
