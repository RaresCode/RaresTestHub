...
from sites.anahr import anahrScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = anahrScraper().return_data()
...
@pytest.mark.API
def test_anahr_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_anahr_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_anahr_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_anahr_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_anahr_status_code_link_api(get_job_details):
