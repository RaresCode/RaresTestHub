...
from sites.zeelandia import zeelandiaScraper
import pytest
import requests
import allure
...
def get_job_details():
    ...
    """
    scraper_data = zeelandiaScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_zeelandia_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_zeelandia_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_zeelandia_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_zeelandia_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_zeelandia_status_code_link_api(get_job_details):
