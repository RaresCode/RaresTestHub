...
from sites.titanmachinery import titanmachineryScraper
import pytest
import requests
import allure
...
def get_job_details():
    ...
    """
    scraper_data = titanmachineryScraper().return_data()
...
@pytest.mark.API
def test_titanmachinery_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_titanmachinery_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_titanmachinery_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_titanmachinery_status_code_link_api(get_job_details):
