...
from sites.typingdna import typingdnaScraper
import pytest
import requests
import allure
...
def get_job_details():
    ...
    """
    scraper_data = typingdnaScraper().return_data()
...
@pytest.mark.API
@pytest.mark.skip
def test_typingdna_title_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_typingdna_city_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_typingdna_country_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_typingdna_link_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_typingdna_status_code_link_api(get_job_details):
