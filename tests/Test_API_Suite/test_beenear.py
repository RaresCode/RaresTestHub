...
def get_job_details():
    ...
    """
    scraper_data = BeenearScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_beenear_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_beenear_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_beenear_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_beenear_link_api(get_job_details):
