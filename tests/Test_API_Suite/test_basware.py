...
from sites.basware import baswareScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = baswareScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.regression
@pytest.mark.API
def test_basware_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_basware_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_basware_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_basware_status_code_link_api(get_job_details):
