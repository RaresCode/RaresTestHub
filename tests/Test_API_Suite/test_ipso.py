...
from sites.ipso import ipsoScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = ipsoScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_ipso_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_ipso_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_ipso_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_ipso_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_ipso_status_code_link_api(get_job_details):
