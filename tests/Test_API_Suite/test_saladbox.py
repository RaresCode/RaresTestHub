...
from sites.saladbox import saladboxScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = saladboxScraper().return_data()
...
@pytest.mark.API
def test_saladbox_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_saladbox_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_saladbox_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_saladbox_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_saladbox_status_code_link_api(get_job_details):
