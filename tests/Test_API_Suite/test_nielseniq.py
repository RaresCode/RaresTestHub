...
from sites.nielseniq import nielseniqScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = nielseniqScraper().return_data()
...
@pytest.mark.API
def test_nielseniq_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_nielseniq_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_nielseniq_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_nielseniq_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_nielseniq_status_code_link_api(get_job_details):
