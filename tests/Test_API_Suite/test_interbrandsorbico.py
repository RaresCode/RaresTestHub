...
from sites.interbrandsorbico import InterbrandsOrbicoScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = InterbrandsOrbicoScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.regression
@pytest.mark.API
def test_interbrandsorbico_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_interbrandsorbico_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_interbrandsorbico_status_code_link_api(get_job_details):
