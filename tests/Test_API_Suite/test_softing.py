...
from sites.softing import softingScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = softingScraper().return_data()
...
@pytest.mark.API
def test_softing_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_softing_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_softing_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_softing_status_code_link_api(get_job_details):
