...
from sites.signaliduna import signalidunaScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = signalidunaScraper().return_data()
...
@pytest.mark.API
def test_signaliduna_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_signaliduna_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_signaliduna_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_signaliduna_status_code_link_api(get_job_details):
