...
from sites.britishcouncil import britishcouncilScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = britishcouncilScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_britishcouncil_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_britishcouncil_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_britishcouncil_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_britishcouncil_status_code_link_api(get_job_details):
