...
from sites.leier import leierScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = leierScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_leier_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_leier_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_leier_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_leier_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_leier_status_code_link_api(get_job_details):
