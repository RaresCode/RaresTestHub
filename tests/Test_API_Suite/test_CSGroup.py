...
from sites.csgroup import CSGroupScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = CSGroupScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_CSGroup_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_CSGroup_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_CSGroup_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_CSGroup_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_CSGroup_status_code_link_api(get_job_details):
