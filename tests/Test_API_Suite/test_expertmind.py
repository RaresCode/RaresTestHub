...
from sites.expertmind import expertmindScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = expertmindScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_expertmind_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_expertmind_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_expertmind_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_expertmind_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_expertmind_status_code_link_api(get_job_details):
