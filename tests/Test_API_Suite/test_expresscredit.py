...
from sites.expresscredit import expresscreditScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = expresscreditScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_expresscredit_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_expresscredit_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_expresscredit_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_expresscredit_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_expresscredit_status_code_link_api(get_job_details):
