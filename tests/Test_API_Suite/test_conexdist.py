...
from sites.conexdist import conexdistScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = conexdistScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_conexdist_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_conexdist_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_conexdist_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_conexdist_status_code_link_api(get_job_details):
