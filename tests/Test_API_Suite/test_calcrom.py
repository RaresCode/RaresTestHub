...
from sites.calcrom import calcromScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = calcromScraper().return_data()
...
@pytest.mark.API
def test_calcrom_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_calcrom_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_calcrom_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_calcrom_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_calcrom_status_code_link_api(get_job_details):
