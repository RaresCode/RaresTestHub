...
from sites.netrom import netromScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = netromScraper().return_data()
...
@pytest.mark.API
def test_netrom_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_netrom_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_netrom_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_netrom_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_netrom_status_code_link_api(get_job_details):
