...
from sites.noodlepack import noodlepackScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = noodlepackScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_noodlepack_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_noodlepack_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_noodlepack_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_noodlepack_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_noodlepack_status_code_link_api(get_job_details):
