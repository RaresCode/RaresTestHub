...
from sites.dentesse import dentesseScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = dentesseScraper().return_data()
...
@pytest.mark.API
def test_dentesse_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_dentesse_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_dentesse_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_dentesse_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_dentesse_status_code_link_api(get_job_details):
