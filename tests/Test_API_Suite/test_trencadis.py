...
from sites.trencadis import trencadisScraper
import pytest
import requests
import allure
...
def get_job_details():
    ...
    """
    scraper_data = trencadisScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_trencadis_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_trencadis_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_trencadis_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_trencadis_link_api(get_job_details):
