...
from sites.takeandeat import takeandeatScraper
import pytest
import requests
import allure
...
def get_job_details():
    ...
    """
    scraper_data = takeandeatScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_takeandeat_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_takeandeat_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_takeandeat_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_takeandeat_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_takeandeat_status_code_link_api(get_job_details):
