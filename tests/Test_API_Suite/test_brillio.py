...
from sites.brillio import brillioScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = brillioScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
@pytest.mark.skip
def test_brillio_title_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_brillio_city_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_brillio_country_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_brillio_link_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_brillio_status_code_link_api(get_job_details):
