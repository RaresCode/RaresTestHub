...
from sites.speedservicesatumare import speedservicesatumareScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = speedservicesatumareScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_speedservicesatumare_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_speedservicesatumare_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.APIAPI
def test_speedservicesatumare_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_speedservicesatumare_status_code_link_api(get_job_details):
