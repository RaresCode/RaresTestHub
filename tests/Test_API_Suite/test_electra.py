...
from sites.electra import electraScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = electraScraper().return_data()
...
@pytest.mark.API
def test_electra_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_electra_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_electra_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_electra_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_electra_status_code_link_api(get_job_details):
