...
from sites.nokia import nokiaScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = nokiaScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
@pytest.mark.skip
def test_nokia_title_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_nokia_city_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_nokia_country_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_nokia_link_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_nokia_status_code_link_api(get_job_details):
