...
from sites.softexco import softexcoScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = softexcoScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_softexco_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_softexco_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_softexco_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_softexco_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_softexco_status_code_link_api(get_job_details):
