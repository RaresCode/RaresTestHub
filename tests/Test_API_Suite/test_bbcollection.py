...
from sites.bbcollection import bbcollectionScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = bbcollectionScraper().return_data()
...
@pytest.mark.API
def test_bbcollection_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bbcollection_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bbcollection_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bbcollection_status_code_link_api(get_job_details):
