...
from sites.secondtex import secondtexScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = secondtexScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_secondtex_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_secondtex_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_secondtex_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_secondtex_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_secondtex_status_code_link_api(get_job_details):
