...
from sites.reginamaria import reginamariaScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = reginamariaScraper().return_data()
...
@pytest.mark.regression
@pytest.mark.API
def test_reginamaria_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_reginamaria_status_code_link_api(get_job_details):
