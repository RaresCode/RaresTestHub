...
def get_job_details():
    ...
    """
    scraper_data = sephoraScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_sephora_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_sephora_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_sephora_status_code_link_api(get_job_details):
