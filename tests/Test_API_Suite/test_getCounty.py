...
from sites.getCounty import getCountyScraper
import pytest
import allure
import requests

company_name = 'getCounty'
...
def get_job_details():
    ...
    """
    scraper_data = getCountyScraper().return_data()
...
@pytest.mark.API
def test_getCounty_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_getCounty_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_getCounty_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_getCounty_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_getCounty_status_code_link_api(get_job_details):
