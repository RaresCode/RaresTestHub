...
from sites.eurotech import eurotechScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = eurotechScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_eurotech_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_eurotech_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_eurotech_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_eurotech_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_eurotech_status_code_link_api(get_job_details):
