...
from sites.etusoft import etusoftScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = etusoftScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_etusoft_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_etusoft_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_etusoft_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_etusoft_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_etusoft_status_code_link_api(get_job_details):
