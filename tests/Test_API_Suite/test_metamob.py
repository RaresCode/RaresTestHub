...
from sites.metamob import metamobScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = metamobScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_metamob_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_metamob_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_metamob_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_metamob_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_metamob_status_code_link_api(get_job_details):
