...
from sites.kimballelectronics import kimballelectronicsScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = kimballelectronicsScraper().return_data()
...
@pytest.mark.API
def test_kimballelectronics_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_kimballelectronics_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_kimballelectronics_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_kimballelectronics_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_kimballelectronics_status_code_link_api(get_job_details):
