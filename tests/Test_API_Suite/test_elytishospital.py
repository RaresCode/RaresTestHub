...
from sites.elytishospital import elytishospitalScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = elytishospitalScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.regression
@pytest.mark.API
def test_elytishospital_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_elytishospital_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_elytishospital_status_code_link_api(get_job_details):
