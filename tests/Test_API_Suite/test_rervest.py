...
from sites.rervest import rervestScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = rervestScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.regression
@pytest.mark.API
def test_rervest_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_rervest_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_rervest_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_rervest_status_code_link_api(get_job_details):
