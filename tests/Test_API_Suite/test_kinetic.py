...
from sites.kinetic import kineticScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = kineticScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_kinetic_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_kinetic_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_kinetic_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_kinetic_status_code_link_api(get_job_details):
