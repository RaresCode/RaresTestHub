...
from sites.zucchetti import zucchettiScraper
import pytest
import requests
import allure
...
@pytest.mark.API
def test_zucchetti_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_zucchetti_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_zucchetti_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_zucchetti_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_zucchetti_status_code_link_api(get_job_details):
