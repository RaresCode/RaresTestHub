...
from sites.casaautoiasi import casaautoiasiScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = casaautoiasiScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_casaautoiasi_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_casaautoiasi_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_casaautoiasi_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_casaautoiasi_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_casaautoiasi_status_code_link_api(get_job_details):
