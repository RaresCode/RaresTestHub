...
from sites.urbica import urbicaScraper
import pytest
import requests
import allure
...
def get_job_details():
    ...
    """
    scraper_data = urbicaScraper().return_data()
...
@pytest.mark.API
def test_urbica_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_urbica_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_urbica_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_urbica_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_urbica_status_code_link_api(get_job_details):
