...
from sites.iuliuscompany import iuliuscompanyScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = iuliuscompanyScraper().return_data()
...
@pytest.mark.regression
@pytest.mark.API
def test_iuliuscompany_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_iuliuscompany_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_iuliuscompany_status_code_link_api(get_job_details):
