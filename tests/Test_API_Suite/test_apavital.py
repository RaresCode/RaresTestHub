...
from sites.apavital import apavitalScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = apavitalScraper().return_data()
...
@pytest.mark.API
def test_apavital_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_apavital_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_apavital_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_apavital_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_apavital_status_code_link_api(get_job_details):
