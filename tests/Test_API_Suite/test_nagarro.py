...
from sites.nagarro import NagarroScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = NagarroScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_nagarro_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_nagarro_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_nagarro_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_nagarro_status_code_link_api(get_job_details):
