...
from sites.edutrust import edutrustScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = edutrustScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_edutrust_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_edutrust_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_edutrust_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_edutrust_link_api(get_job_details):
