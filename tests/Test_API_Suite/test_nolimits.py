...
from sites.nolimits import NolimitsScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = NolimitsScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_nolimits_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_nolimits_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_nolimits_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_nolimits_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_nolimits_status_code_link_api(get_job_details):
