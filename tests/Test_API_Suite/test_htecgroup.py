...
from sites.htecgroup import htecgroupScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = htecgroupScraper().return_data()
...
@pytest.mark.API
def test_htecgroup_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_htecgroup_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_htecgroup_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_htecgroup_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_htecgroup_status_code_link_api(get_job_details):
