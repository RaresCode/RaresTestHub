...
from sites.sandra import sandraScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = sandraScraper().return_data()
...
@pytest.mark.API
def test_sandra_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_sandra_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_sandra_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_sandra_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_sandra_status_code_link_api(get_job_details):
