...
from sites.covalact import covalactScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = covalactScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_covalact_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_covalact_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_covalact_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_covalact_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_covalact_status_code_link_api(get_job_details):
