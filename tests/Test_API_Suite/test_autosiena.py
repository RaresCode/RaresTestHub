...
from sites.autosiena import autosienaScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = autosienaScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_autosiena_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_autosiena_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_autosiena_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_autosiena_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_autosiena_status_code_link_api(get_job_details):
