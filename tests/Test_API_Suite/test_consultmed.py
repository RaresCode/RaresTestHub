...
from sites.consultmed import consultmedScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = consultmedScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_consultmed_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_consultmed_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_consultmed_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_consultmed_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_consultmed_status_code_link_api(get_job_details):
