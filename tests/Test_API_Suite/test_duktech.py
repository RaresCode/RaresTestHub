...
from sites.duktech import duktechScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = duktechScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_duktech_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_duktech_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_duktech_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_duktech_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_duktech_status_code_link_api(get_job_details):
