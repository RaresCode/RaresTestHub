...
from sites.pimcopy import pimcopyScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = pimcopyScraper().return_data()
...
@pytest.mark.API
def test_pimcopy_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_pimcopy_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_pimcopy_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_pimcopy_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_pimcopy_status_code_link_api(get_job_details):
