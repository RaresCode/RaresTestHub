...
from sites.cargus import CargusScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = CargusScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_cargus_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_cargus_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_cargus_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_cargus_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_cargus_status_code_link_api(get_job_details):
