...
from sites.panifcom import panifcomScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = panifcomScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_panifcom_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_panifcom_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_panifcom_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_panifcom_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_panifcom_status_code_link_api(get_job_details):
