...
from sites.rdnautomatic import rdnautomaticScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = rdnautomaticScraper().return_data()
...
@pytest.mark.API
def test_rdnautomatic_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_rdnautomatic_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_rdnautomatic_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_rdnautomatic_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_rdnautomatic_status_code_link_api(get_job_details):
