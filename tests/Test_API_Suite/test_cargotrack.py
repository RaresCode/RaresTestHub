...
from sites.cargotrack import cargotrackScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = cargotrackScraper().return_data()
...
@pytest.mark.API
def test_cargotrack_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_cargotrack_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_cargotrack_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_cargotrack_status_code_link_api(get_job_details):
