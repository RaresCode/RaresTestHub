...
from sites.dualit import dualitScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = dualitScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.regression
@pytest.mark.API
def test_dualit_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_dualit_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_dualit_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_dualit_status_code_link_api(get_job_details):
