...
from sites.pago import PagoScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = PagoScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_pago_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_pago_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_pago_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_pago_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_pago_status_code_link_api(get_job_details):
