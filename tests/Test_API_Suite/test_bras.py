...
from sites.bras import brasScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = brasScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_bras_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bras_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bras_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bras_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bras_status_code_link_api(get_job_details):
