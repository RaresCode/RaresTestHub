...
from sites.sinaps import sinapsScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = sinapsScraper().return_data()
...
@pytest.mark.API
def test_sinaps_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_sinaps_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_sinaps_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_sinaps_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_sinaps_status_code_link_api(get_job_details):
