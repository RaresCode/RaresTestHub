...
from sites.atpgroup import atpgroupScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = atpgroupScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.regression
@pytest.mark.API
def test_atpgroup_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_atpgroup_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_atpgroup_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_atpgroup_status_code_link_api(get_job_details):
