...
from sites.autonet import autonetScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = autonetScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_autonet_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_autonet_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_autonet_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_autonet_status_code_link_api(get_job_details):
