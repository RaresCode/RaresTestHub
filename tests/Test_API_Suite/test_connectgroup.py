...
from sites.connectgroup import connectgroupScraper
import pytest
import allure
import requests
...
@pytest.mark.API
def test_connectgroup_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_connectgroup_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_connectgroup_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_connectgroup_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_connectgroup_status_code_link_api(get_job_details):
