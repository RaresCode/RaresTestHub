...
def get_job_details():
    ...
    """
    scraper_data = KaizenGamingScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
@pytest.mark.skip
def test_kaizengaming_title_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_kaizengaming_city_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_kaizengaming_country_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_kaizengaming_link_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_kaizengaming_status_code_link_api(get_job_details):
