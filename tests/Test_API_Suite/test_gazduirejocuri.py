...
from sites.gazduirejocuri import gazduirejocuriScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = gazduirejocuriScraper().return_data()
...
@pytest.mark.API
def test_gazduirejocuri_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_gazduirejocuri_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_gazduirejocuri_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_gazduirejocuri_status_code_link_api(get_job_details):
