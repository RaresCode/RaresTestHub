...
from sites.expomedics import expomedicsScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = expomedicsScraper().return_data()
...
@pytest.mark.API
def test_expomedics_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_expomedics_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_expomedics_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_expomedics_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_expomedics_status_code_link_api(get_job_details):
