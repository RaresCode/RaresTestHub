...
from sites.tcandc import tcandcScraper
import pytest
import requests
import allure
...
def get_job_details():
    ...
    """
    scraper_data = tcandcScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_tcandc_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_tcandc_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_tcandc_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_tcandc_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_tcandc_status_code_link_api(get_job_details):
