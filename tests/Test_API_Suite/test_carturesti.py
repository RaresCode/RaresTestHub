...
from sites.carturesti import carturestiScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = carturestiScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_carturesti_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_carturesti_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_carturesti_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_carturesti_status_code_link_api(get_job_details):
