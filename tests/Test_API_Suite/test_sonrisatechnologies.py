...
from sites.sonrisatechnologies import sonrisatechnologiesScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = sonrisatechnologiesScraper().return_data()
...
@pytest.mark.API
def test_sonrisatechnologies_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_sonrisatechnologies_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_sonrisatechnologies_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_sonrisatechnologies_link_api(get_job_details):
