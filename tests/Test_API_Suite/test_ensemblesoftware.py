...
from sites.ensemblesoftware import ensemblesoftwareScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = ensemblesoftwareScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_ensemblesoftware_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_ensemblesoftware_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_ensemblesoftware_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_ensemblesoftware_status_code_link_api(get_job_details):
