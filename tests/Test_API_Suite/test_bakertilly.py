...
from sites.bakertilly import bakertillyScraper
import pytest
import allure
import requests
...
def get_job_details():
    ...
    """
    scraper_data = bakertillyScraper().return_data()
    testutils = TestUtils()
...
@pytest.mark.API
def test_bakertilly_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bakertilly_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bakertilly_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bakertilly_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bakertilly_status_code_link_api(get_job_details):
